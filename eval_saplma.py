...
if __name__ == "__main__":
    ...
    --bundle pretrained_saplma/instruct/format_2/saplma_checkpoints_LLAMA7/BEST_layer12__heldout_data/capitals \
    --csv /home/ddn1/Documents/GitHub/SAPLMA/data/capital_true_false_instruct/format3/embeddings_with_labels_data/capitalsLLAMA7_12_rmv_period.csv \
    --label-col label \
    --out-dir saplma_tests_results/format_2_model/format_3_test_dataset_results
    
    
    
    python eval_saplma.py \
    --bundle pretrained_saplma/instruct/format_4/saplma_checkpoints_LLAMA7/animals_rep9_bundle \
    --csv /home/ddn1/Documents/GitHub/SAPLMA/data/capital_true_false_instruct/format2/embeddings_with_labels_data/animalsLLAMA7_12_rmv_period.csv \
    --label-col label \
    --out-dir saplma_tests_results/format_4_model_animals_rep9/format_2_test_dataset_results


Animals:

| test(animals) \ train(All but ani.)  |          empty         |      tell_me_true      |     tell_me_false      |
-------------------------------------------------------------------------------------------------------------------
|          empty                       | acc@0.5: 77.28         | acc@0.5: 76.29         | acc@0.5: 69.64         |
-------------------------------------------------------------------------------------------------------------------
|      tell_me_true                    | acc@0.5: 73.61         | acc@0.5: 75.89         | acc@0.5: 70.93         |
-------------------------------------------------------------------------------------------------------------------
|     tell_me_false                    | acc@0.5: 53.37         | acc@0.5: 55.65         | acc@0.5: 78.08         |
-------------------------------------------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------
|          empty                       | acc@0.5: 88.61         | acc@0.5: 92.39         | acc@0.5: 69.62         |
-------------------------------------------------------------------------------------------------------------------
|      tell_me_true                    | acc@0.5: 77.91         | acc@0.5: 91.77         | acc@0.5: 71.12         |
-------------------------------------------------------------------------------------------------------------------
|     tell_me_false                    | acc@0.5: 52.33         | acc@0.5: 82.10         | acc@0.5: 92.25         |
-------------------------------------------------------------------------------------------------------------------
...
| test(capitals) \ train(All but cap.) |          empty         |      tell_me_true      |     tell_me_false      |
-------------------------------------------------------------------------------------------------------------------
|          empty                       | acc@0.5: -----         | acc@0.5: -----         | acc@0.5: -----         |
-------------------------------------------------------------------------------------------------------------------
|      tell_me_true                    | acc@0.5: -----         | acc@0.5: -----         | acc@0.5: -----         |
-------------------------------------------------------------------------------------------------------------------
|     tell_me_false                    | acc@0.5: -----         | acc@0.5: -----         | acc@0.5: -----         |
-------------------------------------------------------------------------------------------------------------------
